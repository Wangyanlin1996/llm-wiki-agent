...
## 关键引述
> "Current AI interaction models treat the prompt as the primary object of exchange, omitting a critical layer: the user's latent source intent" — 核心批评：当前模型遗漏了用户潜在源意图这一关键层

> "The Theorem of Irreversible Intent Loss establishes that private intent absent from the carrier cannot be recovered beyond generic substitution" — 关键定理：缺失的私有意图无法恢复

## 关联
- [[IntentUnderstanding]] — IST 为意图理解提供理论基础
...
- [[IntentRecommendation]] — 主动式 recommendation 补偿缺失的 intent signals
