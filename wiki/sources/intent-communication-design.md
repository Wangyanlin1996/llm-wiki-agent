...
## 关键引述
> "existing models of what to communicate are rarely linked to systematic choices of how and when to communicate" — 鸿沟诊断：现有传达模型很少与何时和如何传达的系统化选择相关联

> "our design space provides a foundation for designing safer, more intuitive, and more transferable agent-human interactions" — 贡献：设计空间为更安全、更直觉、更可迁移的交互奠定基础

## 关联
- [[IntentUnderstanding]] — 设计空间指导意图理解如何被传达
...
## 矛盾
- 与 agent 特定的僵化 communication 矛盾：设计空间主张系统化、可迁移的意图传达策略