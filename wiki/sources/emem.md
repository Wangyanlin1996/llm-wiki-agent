...
## 关键引述
> "prevalent memory preprocessing paradigms suffer from destructive de-contextualization" — 问题诊断：主流记忆预处理范式遭受破坏性去上下文化

> "shifting from Memory Preprocessing to Episodic Context Reconstruction" — 范式转变：从预处理转向情景式上下文重建
