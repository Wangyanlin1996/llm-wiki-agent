...
## 关键引述
> "Statefulness is essential for large language model (LLM) agents to perform long-term planning and problem-solving" — 核心动机：有状态性对长程规划与问题求解至关重要

> "Evo-Memory structures datasets into sequential task streams, requiring LLMs to search, adapt, and evolve memory after each interaction" — 基准设计：将数据集组织为顺序任务流
...
- [[Emem]] — 解决 Evo-Memory 中识别的去上下文化问题的 episodic memory（情景式记忆）范式
