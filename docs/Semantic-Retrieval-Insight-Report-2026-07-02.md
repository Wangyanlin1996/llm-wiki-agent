...
| 7 | [[rag-evaluation-survey]] — RAG 评估方法 | 2025 | arXiv | [2504.14891](https://arxiv.org/abs/2504.14891) | 系统性能/事实准确性/安全/计算效率四维评估 |

### T3 混合检索 Hybrid Retrieval（3 篇）

| #   | 论文                                    | 年份   | Venue | arXiv | 核心贡献                                                     |
| --- | ------------------------------------- | ---- | ----- | ----- | -------------------------------------------------------- |
| 8   | [[telco-orag]] — 电信场景混合检索+神经路由        | 2025 | arXiv | [2505.11856](https://arxiv.org/abs/2505.11856) | 3GPP 检索+Web 混合+神经路由；45% 内存节省；开源 LLM 达 GPT-4 水平——**电信场景** |
| 9   | [[bm25-corrective-rag]] — BM25 超越稠密检索 | 2025 | arXiv | [2604.01733](https://arxiv.org/abs/2604.01733) | BM25+神经重排两阶段；Recall@5=0.816；金融文档 BM25 超越 SOTA 稠密检索       |
| 10  | [[hakari-bench]] — 五族检索模型统一对比         | 2025 | arXiv | [2606.22778](https://arxiv.org/abs/2606.22778) | 稀疏/稠密/混合/重排/LLM 五族统一基准                                   |

### T4 嵌入模型 Embedding Models（4 篇）

| # | 论文 | 年份 | Venue | arXiv | 核心贡献 |
|---|------|------|-------|-------|---------|
| 11 | [[teleembedbench]] — 电信嵌入基准 | 2025 | arXiv | [2604.17778](https://arxiv.org/abs/2604.17778) | 电信首个嵌入基准；LLM embedder 显著优于 sentence-transformer——**电信场景** |
| 12 | [[llm2vec-gen]] — 生成式嵌入 | 2025 | arXiv | [2603.10913](https://arxiv.org/abs/2603.10913) | 在 LLM 输出空间直接生成嵌入；推理时无额外编码 |
| 13 | [[promptembedder]] — 双 LLM 软提示解耦 | 2025 | arXiv | [2605.28066](https://arxiv.org/abs/2605.28066) | 软提示解耦嵌入知识与主干权重；高效可迁移 |
| 14 | [[hteb-harder-embedding-bench]] — 更难的嵌入基准 | 2025 | arXiv | [2605.28190](https://arxiv.org/abs/2605.28190) | MTEB 多维度动态鲁棒性扩展；超越一维静态评估 |

### T5 检索评估 Retrieval Evaluation（2 篇）

| # | 论文 | 年份 | Venue | arXiv | 核心贡献 |
|---|------|------|-------|-------|---------|
| 15 | [[coverage-not-averages]] — 语义分层检索评估 | 2025 | arXiv | [2604.20763](https://arxiv.org/abs/2604.20763) | 评估形式化为统计估计；形式化覆盖保证 |
| 16 | [[rare-redundancy-eval]] — 高冗余语料评估 | 2025 | ACL 2026 | [2604.19047](https://arxiv.org/abs/2604.19047) | 原子事实分解+冗余感知评估；金融/法律/专利场景 |

### T6 GraphRAG（4 篇）

| # | 论文 | 年份 | Venue | arXiv | 核心贡献 |
|---|------|------|-------|-------|---------|
| 17 | [[is-graphrag-needed]] — 9 种 RAG 场景对比 | 2025 | ACL 2026 GEM Workshop | [2606.25656](https://arxiv.org/abs/2606.25656) | 检索-生成差距；扩展检索不比例提升生成质量 |
| 18 | [[multimodal-graphrag]] — 视觉富文档知识图谱 | 2025 | arXiv | [2606.28780](https://arxiv.org/abs/2606.28780) | GraphRAG 扩展到多模态视觉富文档 |
| 19 | [[ex-graphrag]] — 可解释图检索 | 2025 | arXiv | [2605.21994](https://arxiv.org/abs/2605.21994) | M-GNAN 精确分解节点贡献；可解释性 |
| 20 | [[omd-graphrag]] — 本体引导提取 | 2025 | arXiv | [2603.25152](https://arxiv.org/abs/2603.25152) | 本体引导提升领域特定实体/关系精度 |

### T7 Agent 驱动检索 Agentic Retrieval（5 篇）

| #   | 论文                                                      | 年份   | Venue | arXiv | 核心贡献                             |
| --- | ------------------------------------------------------- | ---- | ----- | ----- | -------------------------------- |
| 21  | [[reasoning-agentic-rag-survey]] — System 1 vs System 2 | 2025 | arXiv | [2506.10408](https://arxiv.org/abs/2506.10408) | 预定义推理管线 vs 自主工具编排双范式             |
| 22  | [[r2-searcher]] — 多跳推理检索-推理边界校准                         | 2025 | arXiv | [2606.28566](https://arxiv.org/abs/2606.28566) | 多跳推理中检索-推理边界校准                   |
| 23  | [[kbsd-knowledge-boundary]] — 知识边界校准三决策                 | 2025 | arXiv | [2606.29863](https://arxiv.org/abs/2606.29863) | 信任记忆/依赖检索/弃答三决策                  |
| 24  | [[metaresearcher]] — 对抗虚拟环境+自反思 RL                      | 2025 | arXiv | [2606.19893](https://arxiv.org/abs/2606.19893) | 对抗虚拟环境扩展深度研究能力                   |
| 25  | [[simplesearch-vl]] — 多模态 agentic 搜索                    | 2025 | arXiv | [2606.31504](https://arxiv.org/abs/2606.31504) | 仅需 5K SFT+2K RL 实现多模态 agentic 搜索 |
|     |                                                         |      |       |       |                                  |
...
| #   | 论文                                          | 年份   | Venue | arXiv | 核心贡献                          |
| --- | ------------------------------------------- | ---- | ----- | ----- | ----------------------------- |
| 26  | [[armor-telecom-retriever]] — 电信查询侧检索器自适应优化 | 2025 | arXiv | [2606.29706](https://arxiv.org/abs/2606.29706) | 查询侧检索器自适应优化；低资源电信场景——**电信场景** |
